...
images = [
    ("Uber Driver/2026/May/Week 5/5.26.26", "Screenshot_20260527_044331_Samsung Wallet.jpg"),
    ("Uber Driver/2026/May/Week 5/5.26.26", "Screenshot_20260527_044336_Samsung Wallet.jpg"),
    ("Uber Driver/2026/May/Week 5/5.25.26", "Screenshot_20260525_215951.jpg"),
    ("Uber Driver/2026/May/Week 5/5.25.26", "Whataburger.jpg"),
    ("Uber Driver/2026/May/Week 5/5.25.26", "Screenshot_20260525_214722_Starbucks.jpg")
]

for folder, name in images:
    files = graph.list_folder_files(folder)
    img = next((f for f in files if f.get("name") == name), None)
    if not img:
        print(f"File not found: {name} in {folder}")
        continue
