            ...
            <div className="max-w-2xl mx-auto glass-panel p-10 text-center">
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-400 mt-2">For quotes and inquiries.</p>
                        <a href="mailto:peter.teehan@costesla.com" className="text-xl font-bold mt-2 hover:text-[var(--color-primary)] transition-colors">
