...
$files = Get-ChildItem -Path . -Exclude ".venv", "venv", "*__pycache__*", "*.zip", ".git", ".vscode", "scripts", "local_watcher.py", "*.bak", "apps.txt", "*.json.settings", "summitsyncfunc-settings.json", "summitos-api-settings.json", ".python_packages", "dashboard"
