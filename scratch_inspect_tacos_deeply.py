...
for img, name in [(t1, "Scan_20260526_204311.jpg"), (t2, "Scan_20260527_054933.jpg")]:
    print(f"\n=== DEEP LINE-BY-LINE TRANSCRIPTION FOR: {name} ===")
    ...
    resp = client.chat.completions.create(
        ...
        messages=[{
            "role": "user",
            "content": [
                {"type": "text", "text": "Please transcribe every single line of text on this receipt from top to bottom exactly as it appears. Do not summarize or skip anything. Pay extra attention to the store number, address, date, time, subtotal, tax, and total. Double-check all numbers and letters."},
